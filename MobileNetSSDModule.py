...
class mnSSD:
    def __init__(self, path, threshold):
        ...
        self.net = jetson.inference.detectNet(self.path, threshold=self.threshold)
    ...
    def detect(self, img, display=False):
        ...
        for d in detections:
            ...
            if display:
                ...
                cv2.putText(img, f'FPS: {int(self.net.GetNetworkFPS())}', (30, 30), cv2.FONT_HERSHEY_DUPLEX, 1,
                            (255, 0, 50), 2)
